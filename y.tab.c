...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CNUMBER = 4,                    /* CNUMBER  */
  YYSYMBOL_PLUS = 5,                       /* PLUS  */
  YYSYMBOL_MINUS = 6,                      /* MINUS  */
  YYSYMBOL_TIMES = 7,                      /* TIMES  */
  YYSYMBOL_DIVIDE = 8,                     /* DIVIDE  */
  YYSYMBOL_POWER = 9,                      /* POWER  */
  YYSYMBOL_LEFT_PARENTHESIS = 10,          /* LEFT_PARENTHESIS  */
  YYSYMBOL_RIGHT_PARENTHESIS = 11,         /* RIGHT_PARENTHESIS  */
  YYSYMBOL_END = 12,                       /* END  */
  YYSYMBOL_NEG = 13,                       /* NEG  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "CNUMBER",
  "PLUS", "MINUS", "TIMES", "DIVIDE", "POWER", "LEFT_PARENTHESIS",
  "RIGHT_PARENTHESIS", "END", "NEG", "$accept", "Input", "Line",
  "Expression", "exp", YY_NULLPTR
};
...
{
      21,    -8,    -8,    36,    36,    -8,    16,    -8,    -2,    29,
      -7,    42,    -8,    -8,    36,    36,    36,    36,    36,    -8,
      13,    13,    13,    13,    -8,    -8,    51,    51,    -7,    -7,
      -7,     1,     1,    -8,    -8
};
...
{
       0,     7,    15,     0,     0,     4,     0,     2,     0,     0,
      12,     0,     1,     3,     0,     0,     0,     0,     0,     5,
       0,     0,     0,     0,     6,    14,     8,     9,    10,    11,
      13,    16,    17,    18,    19
};
...
{
      10,    11,    18,    14,    15,    16,    17,    18,    22,    23,
      19,    26,    27,    28,    29,    30,    12,     2,    13,     1,
       2,     0,     3,     0,     1,     2,     4,     3,     5,     0,
       0,     4,     0,     5,    20,    21,    22,    23,     0,     1,
       0,    24,     3,     0,     0,     0,     4,    14,    15,    16,
      17,    18,     0,    25,    31,    32,    33,    34,    16,    17,
      18
};
...
{
       3,     4,     9,     5,     6,     7,     8,     9,     7,     8,
      12,    14,    15,    16,    17,    18,     0,     4,     6,     3,
       4,    -1,     6,    -1,     3,     4,    10,     6,    12,    -1,
      -1,    10,    -1,    12,     5,     6,     7,     8,    -1,     3,
      -1,    12,     6,    -1,    -1,    -1,    10,     5,     6,     7,
       8,     9,    -1,    11,    20,    21,    22,    23,     7,     8,
       9
};
...
{
       0,     3,     4,     6,    10,    12,    15,    16,    17,    18,
      17,    17,     0,    16,     5,     6,     7,     8,     9,    12,
       5,     6,     7,     8,    12,    11,    17,    17,    17,    17,
      17,    18,    18,    18,    18
};
...
#line 65 "calc1.y"
                     { (yyval.cval) = multiplicar((yyvsp[-2].cval),(yyvsp[0].cval)); }
#line 1257 "y.tab.c"
    break;

  case 19: /* exp: exp DIVIDE exp  */
#line 66 "calc1.y"
                     { (yyval.cval) = dividir((yyvsp[-2].cval),(yyvsp[0].cval)); }
#line 1263 "y.tab.c"
    break;
